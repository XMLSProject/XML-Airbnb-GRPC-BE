...
var file_reservation_reservation_service_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x64, 0x61, 0x74, 0x65, 0x54, 0x6f, 0x32, 0xb3, 0x03,
...
var file_reservation_reservation_service_proto_depIdxs = []int32{
	...
	7,  // 10: ReservationService.GreetFromReservation:output_type -> Response
	9,  // 11: ReservationService.Reserve:output_type -> ResponseForReserve
	3,  // 12: ReservationService.DeleteReservation:output_type -> ResponseDeleteReservation
	1,  // 13: ReservationService.AcceptReservation:output_type -> DeleteResponse
	7,  // 14: ReservationService.CheckReservations:output_type -> Response
	15, // 15: ReservationService.CheckReservationsByDates:output_type -> CheckResponse
	12, // 16: ReservationService.GetAllReservations:output_type -> AllReservationsResponse
